...
public class GameReadyControllerScript : MonoBehaviour
{
   ...
   // private bool toggle = true;
    ...
    public Sprite playerOneReadySprite;
    public Sprite playerOneUnReadySprite;
    public Sprite playerTwoReadySprite;
    public Sprite playerTwoUnReadySprite;
    ...
    public void P1ReadyToggle()
    {
        if (p1Ready == false)
        {
            p1ReadyImage.sprite = playerOneReadySprite;
            p1Ready = true;
    ...
    public void P2ReadyToggle()
    {
        if (p2Ready == false)
        {
            p2ReadyImage.sprite = playerTwoReadySprite;
            p2Ready = true;
    ...
    public void P1ReadyClick()
    {
        print("Clicked");
        p1Ready = false;
        p1ReadyImage.sprite = playerOneUnReadySprite;
    ...
    public void P2ReadyClick()
    {
        print("Clicked");
        p2Ready = false;
        p2ReadyImage.sprite = playerTwoUnReadySprite;
